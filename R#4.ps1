...
Import-Module GroupPolicy
        ...
        Set-GPLink -Name RIVERCITY -Target "ou=COMISIONADOS,ou=Usuarios,dc=MENDEZ,dc=LOCAL" -LinkEnabled no -Enforced no
        ...
        Set-GPLink -Name RIVERCITY -Target "ou=GAVA,ou=Usuarios,dc=MENDEZ,dc=LOCAL" -LinkEnabled no -Enforced no
        ...
        Set-GPLink -Name RIVERCITY -Target "ou=R#4,ou=Usuarios,dc=MENDEZ,dc=LOCAL" -LinkEnabled no -Enforced no